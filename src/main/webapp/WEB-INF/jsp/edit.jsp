                        ...
                        <div id="accountDiv" class="span-15 last add-padding-above-20">
                            ...
                            <div id='accountInfo' class="span-15 add-padding-above-20 last">
                                <form action="/user/edit/personalDetails" method="post">
                                    ...
                                    <div class="prepend-1 span-2 append-12 last add-margin-above-20">
                        ...
                        <div id="passwordDiv" class="span-15 last add-padding-above-20">
                            ...
                            <div id='passwordInfo' class="span-15 last add-padding-above-20">
                                <form action="/user/edit/password" method="post">
                                    <div class="span-11 append-4 last">
                                    ...
                                    <div class="prepend-1 span-5 append-9 last add-margin-above-20">
                ...
                <div id="right-container" class="span-7 last">
                    ...
                    <div class="span-6 last add-margin-above-20">
                        <div class="span-6 last ">
                            ...
                            <p>
                                From here you can change your basic account info, language settings, and your tweet privacy and
                                location settings."
                            </p>
                            <hr>
                        </div>
                        ...
                        <div class="span-6 last ">
                            ...
                            <p>
                                Change your Twitter name or emailId anytime without affecting your existing tweets, direct
                                messages, or other data. After changing it, make sure to let your followers know so you'll
                                continue receiving all of your messages with your new email.
                            </p>
                            <hr>
                        </div>
                    </div>
